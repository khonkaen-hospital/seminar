...
<div class="schedule-form">
     ...
     <?php $form = ActiveForm::begin(['id'=>'form-'.$model->formName()]); ?>
          ...
          <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6"> <?= $form->field($model, 'status')->radioList([  '1'=>'แสดง', '0'=>'ซ่อน'], ['prompt' => '']) ?></div>
                    <div class="col-md-6"> <?= $form->field($model, 'type')->radioList(['schedule'=>'Schedule','presentation'=>'Presentation']) ?> </div>
                </div>
          </div>
